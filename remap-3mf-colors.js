...
const PALETTE = [
  ...
  { name: 'Gris', hex: '#575D5E' },
  { name: 'Brun fonçé', hex: '#70462B' },
  { name: 'Brun clair', hex: '#AF8050' },
  { name: 'Crême', hex: '#DDC49B' },
  { name: 'Doré',   hex: '#C49A3C' },
  { name: 'Jaune', hex: '#FFFF00' },
  { name: 'Bleu fonçé', hex: '#007CAF' },
  { name: 'Bleu clair', hex: '#6093AC' },
  { name: 'Rouge', hex: '#BB1F11' },
  { name: 'Vert', hex: '#60993B' },
  { name: 'Rose', hex: '#C4618C' },
  { name: 'Orange', hex: '#F67829' },
];
